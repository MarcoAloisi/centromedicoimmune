...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('dni', models.CharField(max_length=9, unique=True, validators=[centroimmune.models.validate_dni_nie])),
                ('nombre', models.CharField(max_length=50)),
                ('apellidos', models.CharField(max_length=50)),
                ('fecha_nacimiento', models.DateField()),
                ('genero', models.CharField(choices=[('M', 'Masculino'), ('F', 'Femenino'), ('O', 'Otro')], max_length=10)),
                ('direccion', models.CharField(max_length=255)),
                ('telefono', models.CharField(max_length=17, validators=[centroimmune.models.validate_phone])),
                ('correo_electronico', models.EmailField(max_length=254, unique=True)),
                ('historial_medico', encrypted_model_fields.fields.EncryptedTextField(blank=True, null=True)),
                ('informacion_seguro', encrypted_model_fields.fields.EncryptedCharField(blank=True, null=True)),
